...
//   const departmentLinks = {
//     // ... (departmentLinks remain unchanged)
//   };
...
//         <>
//           Sure, here is the link to the {department} department's E Library:{' '}
//           <a href={departmentLinks[department]} target="_blank" rel="noopener noreferrer">
//             {departmentLinks[department]}
//           </a>
//           <br />
//           Happy learning! 🎉
...
//       <div
//         className="h-60 overflow-y-scroll border border-blue-500 p-4 flex flex-col rounded-lg"
//         style={{ maxWidth: '100%' }} // Set maximum width for small screens
//       >
//         {messages.map((message) => (
//           <div
//             key={message.id}
//             className={`mb-4 flex justify-${message.sender === 'bot' ? 'start' : 'end'}`}
//           >
//             <div
//               className={`bg-${message.sender === 'bot' ? 'gray-200' : 'blue-500'} text-${message.sender === 'bot' ? 'gray-700' : 'white'} p-4 rounded-lg max-w-70`}
//             >
//               {message.text}
//             </div>
//           </div>
